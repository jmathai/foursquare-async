...
class EpiFoursquareTest extends PHPUnit_Framework_TestCase
{
  ...
  public $redirectUrl = 'http://www.jaisenmathai.com/foursquare-async/simpleTest.php';
  public $id = '5763863';
  ...
  function testGetAuthorizeurl()
  {
    ...
    $this->assertEquals($aUrl, 'https://foursquare.com/oauth2/authenticate?client_id=a40b1aece83e8d94a08fff1e94f87c2f04af2881a&response_type=code&redirect_uri=http%3A%2F%2Fwww.jaisenmathai.com%2Ffoursquare-async%2FsimpleTest.php', 'Authorize url did not match');
  }
